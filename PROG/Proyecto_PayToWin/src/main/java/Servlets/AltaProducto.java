...
public class AltaProducto extends HttpServlet {
    ...
    protected static Producto recogerProductoFormulario(HttpServletRequest request){
        try{
            ...
            System.out.println(nombre+","+ precio+" "+ iva+" "+stockMinimo+" "+stock+" "+descripcion+" "+categorias);
            ...
            if (nombre != null && descripcion != null && precio != null && iva != null && stock != null && stockMinimo != null && !categorias.isEmpty()) {
                ...
                String rutaImagen = (fichero.getSize() != 0) ? fileName : null;
                System.out.println("HA CREADO LA RUTA DE IMAGEN CON EXITO");
                return new Producto(new ProductoDAO().siguienteCodigo(), utf8(nombre), precio, iva, stockMinimo, stock, utf8(rutaImagen), usuarioCrea, LocalDateTime.now(), null, null, descripcion, categorias);
            }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (usuarioSesion == null || !usuarioSesion.esAdmin()) {
                ...
                try {
                    new ProductoDAO().anyadir(producto);
                ...
                response.sendRedirect("productos.jsp?id=null");
            }
        }
    }
