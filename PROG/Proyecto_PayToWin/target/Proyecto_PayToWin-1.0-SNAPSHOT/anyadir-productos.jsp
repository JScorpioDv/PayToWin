<%-- 
    Document   : anyadir-productos
    Created on : 9 May 2023, 19:22:39
    Author     : ciclost
--%>
...
<html>
    ...
    <body class="cambiar-productos">
        <main class="anyadir-producto">
            ...
            %>
            <form name="formAlta" class="loginBox" action="AltaProducto" method="post" enctype="multipart/form-data">
                <h2>Añadir Producto</h2>
                <div class="fbody">
                    <div class="usuarioBox">
                        <input type="text" name="nom-producto" id="nom-producto" required autofocus>
                    ...
                    <div class="usuarioBox">
                        <input type="number" name="iva" id="iva" min="0" max="100" step="any" required>
                        <label for="iva">IVA</label>

                    </div>

                    <div class="usuarioBox">
                        <input type="number" name="stockMinimo" id="stockMinimo" min="0" step="1" required>
                    ...
                    <div class="usuarioBox">
                        <input type="file" name="foto-producto" id="foto-producto">
                    ...
                    <%
                        ...
                        for (Categoria categoria : categorias) {
                            out.println("<div>");
                            out.println("<input type=\"checkbox\" name=\"categorias\" id=\"" + categoria.getNombre() + "\" value=\"" + categoria.getCodigo() +"\" />");
                ...
                <input class="form-boton" type="reset" value="Vaciar" />
